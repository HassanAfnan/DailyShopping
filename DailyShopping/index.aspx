...
<body>
    ...
    <div class="maincontroller fadeout">
        ...
        <div class="logs">
            ...
            <button type="button" class="btn btn-outline-warning">
                <a class="workit" href="ViewCart.aspx">MyCart</a> 
   ...
   <!--start--> 
        ...
        <div class="btn-group">
            ...
            <asp:Button ID="Button3" runat="server" Text="Login" class="logined btn btn-outline-warning" OnClick="Button3_Click"/>        
                ...
                <div class="card">
                    ...
                    <div class="descs">
                        ...
                        <div>                            
                             ...
                             <!--<a href="Cart.aspx?pid=<%#Eval("Pid") %>" class="btn btn-danger">Add to cart</a>-->
                        </div>
                    </div>
                </div>
              </div>
